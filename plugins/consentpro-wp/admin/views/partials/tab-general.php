...
<form method="post" action="options.php">
    ...
    <table class="form-table" role="presentation">
        <tr>
            ...
            <td>
                <label>
                    <input type="checkbox" name="consentpro_general[enabled]" value="1" <?php checked( ! empty( $options['enabled'] ) ); ?>>
        ...
        <tr>
            ...
            <td>
                <input type="url" id="consentpro-policy-url" name="consentpro_general[policy_url]" value="<?php echo esc_url( $options['policy_url'] ?? '' ); ?>" class="regular-text">
        ...
        <tr>
            ...
            <td>
                <label>
                    <input type="checkbox" name="consentpro_general[geo_enabled]" value="1" <?php checked( ! empty( $options['geo_enabled'] ) ); ?>>
