...
<form method="post" action="options.php">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td>
				<input type="text" id="consentpro-license-key" name="consentpro_license_key" value="<?php echo esc_attr( $consentpro_license_key ); ?>" class="regular-text">
			...
			<td>
				<?php if ( ConsentPro_License::is_pro() ) : ?>
					<span class="consentpro-license-status consentpro-license-status--active">
						<?php esc_html_e( 'Active', 'consentpro' ); ?> - <?php echo esc_html( ucfirst( $consentpro_license['tier'] ?? 'Pro' ) ); ?>
					</span>
