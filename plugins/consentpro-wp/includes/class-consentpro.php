...
class ConsentPro {
    ...
    private function load_dependencies(): void {
        require_once CONSENTPRO_PLUGIN_DIR . 'admin/class-admin.php';
        require_once CONSENTPRO_PLUGIN_DIR . 'admin/class-settings.php';
        require_once CONSENTPRO_PLUGIN_DIR . 'public/class-public.php';
        require_once CONSENTPRO_PLUGIN_DIR . 'public/class-banner.php';
        require_once CONSENTPRO_PLUGIN_DIR . 'includes/class-license.php';
    }
